...
namespace WhenWorksWeb.Data.Migrations
{
    ...
    [Migration("20260830050232_AddCanManageOrganizersIndex")]
    partial class AddCanManageOrganizersIndex
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WhenWorksWeb.Models.EventFinalDate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WhenWorksWeb.Models.Participant", b =>
                {
                    ...
                    b.Property<bool>("CanManageOrganizers")
                        .HasColumnType("bit");
                    ...
                    b.HasIndex("EventId", "CanManageOrganizers");
            ...
            modelBuilder.Entity("WhenWorksWeb.Models.ParticipantAvailability", b =>
                {
                    b.Property<int>("ParticipantId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("ParticipantId", "EventDateId");

                    b.HasIndex("EventDateId");

                    b.ToTable("ParticipantAvailabilities");
                });
            ...
            modelBuilder.Entity("WhenWorksWeb.Models.ParticipantAvailability", b =>
                {
                    b.HasOne("WhenWorksWeb.Models.EventDate", "EventDate")
