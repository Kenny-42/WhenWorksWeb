...
{
    /// <summary>
    /// Completes sign-in for an account with 2FA enabled: the post-password TOTP challenge
    /// <c>Login.cshtml.cs</c> redirects to on <c>RequiresTwoFactor</c>.
    /// </summary>
    public class LoginWith2faModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(bool rememberMe, string returnUrl = null)
        {
            ...
            var result = await _signInManager.TwoFactorAuthenticatorSignInAsync(Input.TwoFactorCode, rememberMe, Input.RememberMachine);
