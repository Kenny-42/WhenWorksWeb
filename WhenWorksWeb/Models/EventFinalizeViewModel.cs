...
/// <summary>
/// One organizer-chosen final date (or date range) on the Finalize tab's "Call the date" card.
/// </summary>
...
/// <summary>
/// View model for the event home page's Finalize tab: the "Call the date" suggestions/add-date
/// form and the "Final dates" list.
/// </summary>
public sealed class EventFinalizeViewModel
{
    /// <summary>
